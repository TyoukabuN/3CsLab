...
public struct Flag128
{
	...
	public Flag128 FlagOrAll(Flag128 f2)
	{
		FlagOr(0, f2.Value0);
		FlagOr(1, f2.Value1);
		FlagOr(2, f2.Value2);
	...
	public Flag128 FlagOrExclusiveAll(Flag128 f2)
	{
	...
	public Flag128 FlagAndAll(Flag128 f2)
	{
		FlagAnd(0, f2.Value0);
		FlagAnd(1, f2.Value1);
		FlagAnd(2, f2.Value2);
	...
	public Flag128 FlagComplementAll(Flag128 f1)
	{
		FlagComplement(0);
		FlagComplement(1);
		FlagComplement(2);
