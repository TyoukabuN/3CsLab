...
namespace TinyGame
{
    public partial class TPlayerEntity : StateMachineEntity , INumericalControl, IActionControl
    {
        ...
        //
        [Rename("跑步系数")] public float runFactor = 2.33f;

        [Rename("步行系数")] public float walkFactor = 1f;
        [Rename("步行速度")] public float walkSpeedMagnitude = 3f;
        //
        [Rename("跳跃高度")] public float jumpHeight = 2f;
        [Rename("可跳跃次数")] public int jumpableTimes = 2;

        [HideInInspector] public int jumpCounter = 0;
        //
        [Rename("冲刺系数")] public float dashFactor = 1.0f;
        [Rename("冲刺")] public float dashForce = 10f;
        //[Rename("冲刺力方向")] public Vector2 dashDirection = Vector2.right;
        [Rename("冲刺持续时间")] public float dashDuration = 0.8f;
