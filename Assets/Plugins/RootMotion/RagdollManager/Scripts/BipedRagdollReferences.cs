	...
	public struct BipedRagdollReferences {
		...
		public bool IsValid(ref string msg) {
			...
			for (int i = 1; i < array.Length; i++) {
				if (array[i] != null && !IsChildRecursive(array[i], root)) {
			...
			for (int i = 0; i < array.Length; i++) {
				for (int i2 = 0; i2 < array.Length; i2++) {
					if (i != i2 && array[i] != null && array[i] == array[i2]) {
		...
		public static BipedRagdollReferences FromAvatar(Animator animator) {
			...
			if (!animator.isHuman)
			{
				r.hips = TransformExtended.FoundTransByName(root, "Bip001 Pelvis");
				r.spine = TransformExtended.FoundTransByName(root, "Bip001 Spine");
				r.chest = TransformExtended.FoundTransByName(root, "Bip001 Spine1");
				r.head = TransformExtended.FoundTransByName(root, "Bip001 Head");
				
				r.leftUpperLeg = TransformExtended.FoundTransByName(root, "Bip001 L Thigh");
				r.leftLowerLeg = TransformExtended.FoundTransByName(root, "Bip001 L Calf");
				r.leftFoot = TransformExtended.FoundTransByName(root, "Bip001 L Foot");
			
				r.rightUpperLeg = TransformExtended.FoundTransByName(root, "Bip001 R Thigh");
				r.rightLowerLeg = TransformExtended.FoundTransByName(root, "Bip001 R Calf");
				r.rightFoot = TransformExtended.FoundTransByName(root, "Bip001 R Foot");
			
				r.leftUpperArm = TransformExtended.FoundTransByName(root, "Bip001 L UpperArm");
				r.leftLowerArm = TransformExtended.FoundTransByName(root, "Bip001 L Forearm");
				r.leftHand = TransformExtended.FoundTransByName(root, "Bip001 L Hand");
			
				r.rightUpperArm = TransformExtended.FoundTransByName(root, "Bip001 R UpperArm");
				r.rightLowerArm = TransformExtended.FoundTransByName(root, "Bip001 R Forearm");
				r.rightHand = TransformExtended.FoundTransByName(root, "Bip001 R Hand");
			}
			else
			{
