...
namespace RootMotion.FinalIK {
	...
	public class IKSolverLookAt : IKSolver {
		...
		/// <summary>
		/// usingBoneOrRootForward
		/// </summary>
		public bool UsingRootForward;
		/// <summary>
		...
		public class LookAtBone: IKSolver.Bone {
			 ...
			 * */
			public void LookAt(Vector3 direction, float weight,bool usingRootForward)
			{
				Vector3 forwardValue = forward(usingRootForward);
				Quaternion fromTo = Quaternion.FromToRotation(forwardValue, direction);
			 ...
			 * */
			public Vector3 forward(bool usingRootForward) {
				
				return  usingRootForward ? root.forward : transform.rotation * axis;
			}
        ...
        protected void SolveSpine() {
			...
			GetForwards(ref spineForwards, spine[0].forward(UsingRootForward), targetForward, spine.Length, clampWeight);
			
			// Rotate each bone to face their look at vectors
			for (int i = 0; i < spine.Length; i++) {
				spine[i].LookAt(spineForwards[i], bodyWeight * IKPositionWeight,UsingRootForward);
			}
		}
        ...
        protected void SolveHead() {
			...
			Vector3 baseForward = spine.Length > 0 && spine[spine.Length - 1].transform != null? spine[spine.Length - 1].forward(UsingRootForward): head.forward(false);
			...
			head.LookAt(headForwards[0], headWeight * IKPositionWeight,false);
		}
        ...
        protected void SolveEyes() {
			...
			for (int i = 0; i < eyes.Length; i++) {
				...
				eyes[i].LookAt(eyeForward[0], eyesWeight * IKPositionWeight,false);
			}
		}
